    ...
    <>
      ...
      {!showAll ? (
        <div className="icon-scrollbar d-flex align-items-center px-3 py-2 bg-white">
          {/* A 버튼 */}
          <button className="btn me-2 fw-bold mainColor" onClick={() => setShowAll(true)}>A</button>
          ...
          {/* ▼ 버튼 */}
          <button className="btn ms-2 fw-bold mainColor" onClick={() => setShowAll(true)}>▼</button>
        </div>
      ) : (
